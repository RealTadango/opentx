...
const FrSkySportSensor sportSensors[] = {
  ...
  { 0x5111, 0x5111, 0, ZSTR_TADANGO_GPS_SATS, UNIT_RAW, 0 },
  { 0x5112, 0x5112, 0, ZSTR_TADANGO_GPS_HDOP, UNIT_RAW, 2 },
  ...
  { 0x5200, 0x5200, 0, ZSTR_TADANGO_USED, UNIT_MILLILITERS, 0 },
  { 0x5201, 0x5201, 0, ZSTR_TADANGO_LEFT, UNIT_MILLILITERS, 0 },
  { 0x5210, 0x5210, 0, ZSTR_TADANGO_FLOW, UNIT_MILLILITERS, 0 },
